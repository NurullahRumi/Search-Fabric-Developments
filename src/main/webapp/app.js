Application.run(function($rootScope) {
    ...
    $rootScope.onAppVariablesReady = function() {
        ...
        $rootScope.Variables.statAppUsrid.dataSet.dataValue = $rootScope.Variables.loggedInUser.getData().name.toUpperCase();
    ...
    $rootScope.notificationVariable1onOk = function(variable, data) {
